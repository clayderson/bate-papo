...
-- -----------------------------------------------------
-- Placeholder table for view `batepapo`.`viewMessageUser`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `batepapo`.`viewMessageUser` (`id` INT, `roomId` INT, `userId` INT, `userNickname` INT, `userColor` INT, `message` INT, `createdAt` INT);

-- -----------------------------------------------------
-- View `batepapo`.`viewMessageUser`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `batepapo`.`viewMessageUser`;
USE `batepapo`;
CREATE  OR REPLACE VIEW `viewMessageUser` AS
SELECT
	message.id AS id,
